...
// NewFormater creates a new instance of Formater. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewFormater(t testing.TB) *Formater {
	mock := &Formater{}
	mock.Mock.Test(t)
